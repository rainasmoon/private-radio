package com.blogspot.rainasmoon.babysitter.web.account;
...
import com.blogspot.rainasmoon.babysitter.dao.HibernateUtils;
...
public class UserAction extends CrudActionSupport<User> {
	...
	public String register() throws Exception {
		addActionMessage("with great power, comes great responsibilit");
		return RELOAD;
	}
